...
const brigadeMedicalPersonnelFilters = [
    ...
    <ReferenceInput source="id" label="Vet medical personnel" reference="brigadeVetPersonnel" allowEmpty>
...
export const BrigadeMedicalPersonnelList = props => {
    ...
    return (<List {...props} filters={brigadeMedicalPersonnelFilters}>
        ...
        <Datagrid rowClick="edit">
            ...
            <ReferenceField source="brigadeId" reference="emergencyCallGroup">
...
export const BrigadeMedicalPersonnelEdit = props => (
    <Edit {...props}>
        <SimpleForm>
            ...
            <ReferenceInput source="brigadeId" reference="emergencyCallGroup">
